...
const getIcon = (icon) => {
  switch (icon) {
    case 'about':
      return <User className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'projects':
      return <Palette className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'qualifications':
      return <Briefcase className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'contact':
      return <Phone className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'github':
      return <Github className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'linkedin':
      return <Linkedin className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'resume':
      return <Notebook className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    case 'past':
      return <Clock className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
    default:
      return <Home className="h-auto w-full md:w-[2.5rem] lg:w-[3rem]" strokeWidth={1.5} />;
  }
};
